...
router.get('/:id', auth(Role.CUSTOMER), validateRequest(BookingValidation.bookingIdParamValidationSchema), BookingControllers.getBookingDetails);
router.patch('/:id/cancel', auth(Role.CUSTOMER), validateRequest(BookingValidation.bookingIdParamValidationSchema), BookingControllers.cancelBooking);
