...
const createStripeCheckoutSession = async (bookingId, amount, serviceName, customerEmail) => {
...
const createSslCommerzSession = async (bookingId, amount, customerEmail) => {
...
const createPaymentIntent = async (customerId, bookingId, provider = 'STRIPE') => {
    ...
    return createStripeCheckoutSession(booking.id, booking.service.price, booking.service.name, booking.customer.email);
};
