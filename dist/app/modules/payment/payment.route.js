...
router.post('/create', auth(Role.CUSTOMER), validateRequest(PaymentValidation.createPaymentValidationSchema), PaymentControllers.createPayment);
...
router.get('/:id', auth(Role.CUSTOMER), validateRequest(PaymentValidation.paymentIdParamValidationSchema), PaymentControllers.getPaymentDetails);
